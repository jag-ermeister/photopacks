        ...
        <div className="flex flex-col gap-8 mx-auto max-w-screen-xl px-4 pb-8 pt-0 sm:pb-16 sm:pt-0 lg:px-6">
          <div className="flex flex-col gap-6">
            ...
            <div className="flex flex-col gap-2 text-2xl md:text-3xl font-normal">
              <div>
                Add a Pack for the Same {mainPack.pack_type} for ONLY $4.99
                Each!
              </div>
            </div>
            <Alert
              ...
              additionalContent={
                <div>
                  You&apos;ll upload a single set of photos of ONE{' '}
                  {mainPack.pack_type.toLowerCase()} and we&apos;ll generate all
                  the photo packs for that subject. For packs featuring a
                  different subject, please make a separate purchase.
                </div>
              }
            >
              Each Added Pack Features the Same Photo Subject
            </Alert>
