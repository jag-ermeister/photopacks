    ...
    <div className="dark">
      <section className="bg-white dark:bg-gray-900">
        <div className="mx-auto max-w-screen-xl px-4 py-8 text-center sm:py-16 lg:px-6">
          ...
          <div className="mb-8 mt-8 space-y-8 md:grid md:grid-cols-3 md:gap-12 md:space-y-0 lg:mt-16">
            <div>
              ...
              <p className="mb-4 text-gray-500 dark:text-gray-400">
                ...
                longer to implement. According to G2, Flowbite is the
            ...
            <div>
              ...
              <h3 className="mb-4 text-2xl font-bold dark:text-white">Train</h3>
              <p className="mb-4 text-gray-500 dark:text-gray-400">
                Enterprise tools cost more, are difficult to use, and take
                longer to implement. According to G2, Flowbite is the
                easiest-to-use tool, with the fastest time to ROI.
