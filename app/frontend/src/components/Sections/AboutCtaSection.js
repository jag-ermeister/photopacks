        ...
        <div className="relative">
          <div className="w-full flex flex-col gap-8 mx-auto max-w-screen-xl px-4 py-8 md:py-24 sm:py-24 lg:px-6">
            ...
            <p className="font-normal md:max-w-screen-md text-lg text-gray-800">
              Step into the forefront of AI innovation with SDXL, setting the
              standard for custom image generation. Our advanced technology not
              only produces superior images but also demands fewer photo
              uploads, setting us apart from the competition.
            </p>
          </div>
        </div>
      </div>
