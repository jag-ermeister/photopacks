...
class Order(models.Model):
    ...
    pack_1_zip_file_url = models.URLField(null=True, blank=True)
    pack_2_zip_file_url = models.URLField(null=True, blank=True)
    pack_3_zip_file_url = models.URLField(null=True, blank=True)
    pack_4_zip_file_url = models.URLField(null=True, blank=True)
    pack_5_zip_file_url = models.URLField(null=True, blank=True)
