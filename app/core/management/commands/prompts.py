...
scifi_pack_1 = [
    ...
    "((((MODELNAME)))), Bladerunner 2049, futuristic jacket, by Derek Gores, ((close up)), by Josan Gonzalez and Tomer Hanuka and Geof Darrow highly detailed, UHD, 8K, trending on artstation",
    ...
    "(MODELNAME), in Star Trek-movie, still, photorealistic, sitting in the captain\'s chair in the interior of a space ship",
    "((MODELNAME)), (Jamie Hewlett comic book style), portrait, scifi city landscape, illustration, comics",
    "((MODELNAME)), Cybernetics, action movie protagonist, warrior, virus, cyberspace, repeating patterns, unreal, sound waves, free melody, digital world, reflection, masterpiece, 32k UHD resolution, high quality, professional photography, depth of filed, sci-fi, cinematic angle, cinematic lights, dynamic warrior pose",
    "((MODELNAME)), Flat illustration, 3d, close up, cosplaying Jedi from Star wars movie, in bogus room environment made of cardboard boxes and curtains, treetop house atmosphere, sci-fi vibes",
    "((MODELNAME)), pulp sci fi, style of Irakli Nadar,  style cinematic, Roger Wilcos, portrait of attractive starship captain, dynamic pose, Jetsons inspired spaceship, HUD, LED, Binary, console, surreal , mystical, dynamic lighting perfect proportions 16k resolution concept art",
    "((MODELNAME)), Extremely detailed 8k wallpaper, an iconic character from Star Wars tv series, (eye contact), (half-body shot:2), action-packed, sci-fi vibes, (hyperrealism), stoic cinematic, dark moody",
    "((MODELNAME)), full body portrait of a jedi, Star Wars themed, expressive, sci-fi, fantasy, visually striking, visible brush strokes, textured, grain, captivating, a blend of hyper-realistic drawing, digital illustration, ink painting, oil painting, watercolor painting, style of artists like Guy Denning, Russ Mills, Daniel F Gerhartz, intricate, detailed",
    "((MODELNAME)), (portrait), surreal atmosphere, city, future, sci-fi, epic fantasy photo, illuminated by a red and blue light, with a lot of mushrooms, a stream of water, a city made of crystals, beautiful picture, the sky is full of stars and nebulae and planet, lensflare, dynamic light, 8k, uhd, ultra realistic photo, realistic photography, cinematic view, cinematic angle, best quality, masterpiece, fantasy city portrait:25",
    "((MODELNAME)), a detailed painting portrait inspired by moebius and beksinski of a vibrant friendly alien with aurora inspired by greek sculpture. inspired by alien. science fiction poster. head and chest only. upperbody. cinematic sci - fi scene. accurate anatomy. symmetry. portrait and science fiction theme with lightning, aurora lighting. clouds and stars. smoke. futurism. fantasy. by beksinski carl spitzweg. baroque elements. baroque element. intricate artwork by caravaggio. oil painting. oil on canvas. award winning. dramatic. trending on artstation, 8k",
    "((MODELNAME)), Daily Theme - Visions of Tomorrow, sci-fi, sitting in a machinic bubble ship looking around city, cinematic tension and lighting, gorgeous futuristic scene, 4k, organic cyborg, white plastic, diffused lighting, long lens shot",
    "((MODELNAME)), A portrait of a cosmic graffiti artist, done in a psychedelic style with vibrant colors, sci-fi elements, and intricate details in 4K high quality.",
    "((MODELNAME)), inside a mechanical exoskeleton machine, steampunk, cyberpunk, futuristic, sci-fi, on a battlefield",
    "((MODELNAME)), a detailed painting portrait inspired by moebius and beksinski of a vibrant friendly alien with aurora inspired by greek sculpture. inspired by alien. science fiction poster. head and chest only. upperbody. cinematic sci - fi scene. accurate anatomy. symmetry. portrait and science fiction theme with lightning, aurora lighting. clouds and stars. smoke. futurism. fantasy. by beksinski carl spitzweg. baroque elements. baroque element. intricate artwork by caravaggio. oil painting. oil on canvas. award winning. dramatic. trending on artstation. 8 k",
    "((MODELNAME)), hyper-realistic, in the style retro sci-fi, composition by Gustav Klimt, meticulous portraiture, 8k, cinematic",
    "((MODELNAME)), in a futuristic suit posing for a picture, cyberpunk art by Lü Ji, trending on cg society, retrofuturism, futuristic, sci-fi, anime aesthetic",
]
...
fantasy_pack_1 = [
    ...
    "((MODELNAME)), ((portrait)), fantasy tiefling, (two horns), ((fantasy tiefling)), close up, dnd art, (art by Greg Rutkowski), highly detailed, sharp focus, 4k, ((in a forest)), (((magic glow)))",
    ...
    "((MODELNAME)), as a beautiful dnd miniature figurine, as a fantasy paladin, miniature terrain, mountainous background",
    ...
    "Award-winning, photograph of ((MODELNAME)), a fantasy sorcerer, white robes with gold trim, holding a highly decorated glowing golden staff, cinematic 4k epic detailed bokeh hbo dark moody",
    "((MODELNAME)), Massive detailed animated masterpiece of DnD race wood elf, jungle, full body, intricate hair, ultra detailed revealing hunt outfit, 32k, divine proportion, dim cinematic lighting, ultra detailed textures, perfect proportions, ultra-shiny detailed art by Russell Dongjun Lu, legendary person, noir-inspired portrait, exuding a sense of mysterious allure and captivating the viewer with its enigmatic gaze, dramatic character",
    "((MODELNAME)), Fantastic concept art, dim, hell, underworld masterpiece, shadows, epic, insanely detailed, 32k resolution, intricate inpunk by Artgerm, James jean, Brian froud, Ross Tran, DnD art, art VT, CCG, highly detailed, realistic, 4 HD, Miki Asai Macro photography, close-up, hyper detailed, trending on artstation, sharp focus, studio photo, intricate details, highly detailed, by greg rutkowski",
    "((MODELNAME)), standing in a field , at sun rise, awesome warrior from Final Fantasy, diabolical armor , photo shooting, pixar animation, highly detailed armor, castle in distant background",
    "((MODELNAME)), a mysterious cloaked figure surrounded by swirling steam smoke and sparks, an anime drawing, trending on Artstation, serial art, martin ansin artwork portrait, at nighttime, dan mumford , disco elysium artwork, makoto sinkai, detailed anime artwork, bright colors, dark tones, intricate details, energetic composition, symmetrical, by sam yang, by makoto shinkai, (traditional venitian mask)",
    "((MODELNAME)), medieval armor, crown, detailed eyes, ultra sharpness, highest quality, art by Anya Millen, smooth, clear focus, trending in Artforum, Behance HD, dim colors, evil grin, different angles, scenes from the series Game of Thrones",
    "((MODELNAME)), breathtaking, anime artwork, Masterpiece, Best Quality Human, heavy intricate Armour, intricate armored kilt, dark green clothes, brown boots, smiling, portrait, face lit by light, standing on a hill with a castle in the background, 8k, UHD, HDR . anime style, key visual, vibrant, studio anime, highly detailed . award-winning, professional, highly detailed",
    "((MODELNAME)), Masterpiece, Best Quality, Horror movie poster. Ominous hooded figure looming with blade, gothic castle, full moon, screams in night . , 8k, UHD, HDR",
    "Realistic ((MODELNAME)) with black scary armor, Holding fire Sword, human face, perfectly detailed on dragon armors, Super detail face, high details on face, realistic face, character highly detailed, character sheets, Detailed, sharp focus, Super detailed full body, 32k resolution, Only a reality graphic, epic background, epic pose, horror, high resolution, Resonance, fire and ash background --niji --ar 9:16",
    "((MODELNAME)), magnificent detailed Vampire with bat wings, wings outstretched with gold chrome tips on feathers, intricate ornate marble and bone interwoven and spiraling patterns, final fantasy style, Vampire wearing translucent chrome feathered dress, cinematic lighting, atmospheric, hyper detailed, photoreal, 8k, Unreal engine 5, stan Winston studio, 9:16"
]
...
abstract_pack_1 = [
    ...
    "((MODELNAME)), an abstract head with animallike features, in the style of futuristic cyberpunk, james jean, light brown and cyan, highly detailed illustrations, symmetrical balance, jeff danziger, aykut aydogdu --ar 37:55 --stylize 750 --v 5. 2",
    "((MODELNAME)), A stylized abstract style painting of MODELNAME with a polished, metallic complexion, closed eyes with full lashes, and full lips, exuding serenity. Hair is a cascade of orange, red, blue, and teal, with the strands transitioning smoothly between these colors, creating a liquid-like effect. Incorporate abstract elements with curving lines and circular patterns that resonate with the hair's movement, using a vivid and contrasting color palette. The background has blocks of color that layer and complement the subject, enhancing the depth and energy of the portrait.",
    "((MODELNAME)), a psychedelic bioluminescent, vibrant color palette dominated by orange, pink, green and blue tones, multicolored rainbow portrait inspired by moebius and beksinski of a vibrant, iridescent skin, oil on water effect, rainbow-colored liquid melting silver surfer, detailed sculpture, accurate anatomy, symmetry on surreal, (hypnosis spinner background:1. 3), by beksinski carl spitzweg. intricate artwork by caravaggio. oil painting. oil on canvas. award winning. dramatic. trending on artstation. 8k, fantastic view, 8k, UHD, HDR, (Masterpiece:1. 5), black background (glowing blue eyes:1. 5)",
    "((MODELNAME)), unnerving, horror painting of a butterfly which is the angel of Death, inspired [by Zdzisław Beksiński , Johann Heinrich Füssli , Luis Ricardo Falero] and (John William Waterhouse , Caravaggio) , [by Pallas Athena, Gustav Klimt, the Pre-Raphaelites, Leonardo da Vinci, Sandro Botticelli, James McNeill Whistler, Joseph Mallord, William Turner, Odilon Redon and Salvador Dali], with touches of gold and silver. Detailed, intricate, complex, psychedelic, all hues, all shades, light and dark, colorful, vibrant, shimmering, glimmering, dramatic lighting, centered",
    "((MODELNAME)), Masterpiece, Best Quality, Psychedelic blacklight poster, Day-glo ink, hippie motifs, far out 60s art , 8k, UHD, HDR",
    "poster of ((MODELNAME)) sitting on a chair with a table in front, centered| key visual| intricate| highly detailed| breathtaking| precise lineart| vibrant| panoramic| cinematic| Carne Griffiths| Conrad Roset",
    "graffiti style ((MODELNAME)) highly detailed. street art, vibrant, urban, detailed, tag, mural",
    "((MODELNAME)), An image inspired by art deco and cubism, featuring MODELNAME with a poised expression. Portrait is composed of sharp geometric shapes and smooth curves with a color palette of orange, red, brown, and cream. The facial features are expressive, with large eyes, arched eyebrows, and full lips, set against a background of abstract geometric patterns that flow into the attire, creating a sense of unity. The style blends modern graphic illustration with elements from historical art movements.",
    "((MODELNAME)), High-resolution, abstract expressionist painting, vibrant portrait of a MODELNAME, ((intense brushwork:1. 4)), vivid and bold outlines, ((colorful and vibrant:1. 3)), abstract background with various colors, primarily shades of purple, ((expressive strokes:1. 5)), ((dynamic composition)), vivid and bright hues, ((energy and movement)), ((bold and daring)), ((artistic freedom)), unconventional and expressive style, ((creative experimentation)), ((captivating and engaging)), ((Tischade glasses:1. 6)), ((abstract and free-flowing)), ((rich and textured)), ((artistic flair)), ((chromatic diversity)), captured with a professional DSLR camera, artistically trending on galleries and art forums, ((impressionistic elements)), dynamic and freeform creation, ((abstract expressionism:1. 6)), ((bold color contrast)), ((captivating brushstrokes)), ((flourishing with creativity)), ((mesmerizing visual impact))",
    "((MODELNAME)), The image depicts a Mycelium world, which is a fantastical and surreal environment. The central figure is MODELNAME, surrounded by a vibrant and chaotic landscape. The face is surrounded by a mix of vines, branches, and other organic elements, creating a sense of being engulfed by nature. The scene is further enhanced by the presence of a fire in the background, adding to the dramatic and intense atmosphere. The overall impression is one of awe and wonder, as the viewer is drawn into this imaginative and otherworldly realm.",
    "((MODELNAME)), close up portrait, with mean look, colorful smoke, mystical, dark, dramatic light, epic composition, 12K, hyperrealism, unforgettable, in the style of mike deodato, realistic detail, realistic hyper-detailed rendering, realistic painted still lifes, insanely intricate"
]
...
fashion_pack_1 = [
    ...
    "((MODELNAME)), full-length portrait of a stylish woman in luxurious attire. She has a sleek hairstyle, with understated makeup and gold earrings. She wears a beige fur coat with a dark fur collar over a black turtleneck, paired with camel-colored, high-waisted trousers and black stiletto heels. In her hand is a structured black leather handbag. The background is a dark, textured wall. The style is hyperrealistic, reflecting a modern, high-fashion aesthetic with a focus on texture and detail.",
    "((MODELNAME)), Produce an image capturing the essence of chic urban street style in a bustling metropolis. Generate a 4K scene with fashion-forward individuals donning stylish, everyday outfits. Pay attention to the details of accessories, textures, and diverse styles. Infuse the atmosphere with a dynamic and candid energy, showcasing the intersection of individuality and urban fashion flair",
    "((MODELNAME)), Raw, Masterpiece, highly detailed character design, symmetrical, perfectly centered portrait of a gorgeous woman wearing a pink fluffy coat, innocent face, glowing skin, Highly detailed eyes and face, Long Flowing Hairs, full body, perfect body, perfect arms, perfect hands, perfect fingers, studio photoshoot, Studio Lights, model shoot style, maximum details, photorealism",
    "((MODELNAME)), Photoshoot by fabulous Annie Leibovitz, 60-30-10 color rule, divine proportion, spectacular, in autumn park, 32k, divine proportion, ultra detailed textures, perfect proportions, exuding a sense of mysterious allure, epic character, photoshoot in beautifully lit, magic atmosphere",
    "((MODELNAME)), This is a 1960s Vogue cover photo. It's a close - up shot using a Mamiya RB67 on Kodak Tri - X 400 film stock. The warm and golden lighting was captured late in the afternoon at a small bistro in Morocco. (The model is wearing a flowy white dress). Her makeup is natural and she exudes curiosity about what the day will hold. perfecteyes, natural skin",
    "((MODELNAME)), Fashion editorial style pictorialist style photo of woman, supermodel in post modern environment, full body, masterpiece, soft diffused lighting, eye level, Hasselblad X1D II, Porta 160, Voigtländer Nokton 50mm f1. 1, bokeh, in the style of Garry Winograd . High fashion, trendy, stylish, editorial, magazine style, professional, highly detailed",
    "((MODELNAME)), Luxury product style b&w Emulating the emotional intensity and gravity of wartime black and white photos, shot from a distance, masterpiece photo of a woman, Western-style shirt, denim shorts, cowboy boots, A dramatic cliffside overlook at twilight, capturing the mysterious and moody light. , Ground level architectural view, Canon AE-1, in style of Alex Timmermans . Elegant, sophisticated, high-end, luxurious, professional, highly detailed",
    "((MODELNAME)), A half Body Photo of a beautiful MODELNAME Scottish girl, natural skin complexion, slim with curves, tartan shirt, outdoor background, soft lighting, captured by {randomly selected} photographer. This image looks glamorous and elegant in style and outdoor background that was recognized as a contest winner. It has been featured on CG Society. Cinematic",
